      ...
      <div class="stage">
        ...
        <nav class="rail" id="rail" aria-label="Tools">
          ...
          <div class="modeseg" id="mode-seg" role="group" aria-label="Workspace — code, build, result, and the source panel">
            ...
            <button class="modeseg-opt pane" id="seg-panel" type="button" data-action="panel" aria-pressed="false" aria-label="Show or hide the side panel" title="Show / hide the side panel"><span class="pane-ic" aria-hidden="true"></span></button>
          </div>
          <div class="rail-sep"></div>
